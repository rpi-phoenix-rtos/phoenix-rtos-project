...
#define PLO_RPI_GPIO_GPFSEL4   0xfe200010u
#define PLO_RPI_GPIO_GPSET1    0xfe200020u
#define PLO_RPI_GPIO_GPCLR1    0xfe20002cu
#define PLO_RPI_GPIO42_SHIFT   6u
#define PLO_RPI_GPIO42_OUTPUT  (1u << PLO_RPI_GPIO42_SHIFT)
#define PLO_RPI_GPIO42_BIT     10u
#define PLO_RPI_GPIO42_MASK    (1u << PLO_RPI_GPIO42_BIT)
